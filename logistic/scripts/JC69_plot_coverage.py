...
def plot_figs(stats_path, true_path, parameter_list):
    ...
    parameter_map = {
        "nCarryingCapacity": "nCarryingCapacity",
        "t50": "t50",
        "b": "b",
    ...
    for parameter in parameter_list:
        try:
            true_values = [x[parameter_map[parameter]] for x in true]
    ...
    for parameter in parameter_list:
        ...
        try:
            ...
            output_path = "/Users/xuyuan/workspace/PopFunc-papaer/logistic/figures/" + parameter.lower().replace(".", "_") + ".pdf"
...
# gt16 simulation 3
parameters = ["nCarryingCapacity", "t50", "b", "tree.height", "tree.treeLength"]
stats_format = "/Users/xuyuan/workspace/PopFunc-papaer/logistic/stats/logistic_Coal-%d_stats.log"
true_format = "/Users/xuyuan/workspace/PopFunc-papaer/logistic/data/logistic_Coal-%d.log"
