...
def append_stats_all():
    for i in range(100):
        tree_file = "/Users/xuyuan/workspace/PopFunc-papaer/logistic/data/logistic_Coal-%d_tree.trees" % i
        true_file = "/Users/xuyuan/workspace/PopFunc-papaer/logistic/data/logistic_Coal-%d.log" % i
