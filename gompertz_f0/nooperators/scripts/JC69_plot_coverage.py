...
def plot_figs(stats_path, true_path, parameter_list):
    ...
    for parameter in parameter_list:
        ...
        try:
            ...
            output_path = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_f0/nooperators/figures/" + parameter.lower().replace(".", "_") + ".pdf"
...
# gt16 simulation 3
parameters = ["f0", "N0", "b", "tree.height", "tree.treeLength"]
stats_format = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_f0/nooperators/stats/gompCoal-%d_stats.log"
true_format = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_f0/nooperators/data/gompCoal-%d.log"
