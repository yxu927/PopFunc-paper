...
mcmc_path <- "/Users/xuyuan/workspace/PopFunc-paper/gompertz_f0/nooperators/beast"
output_path <- "/Users/xuyuan/workspace/PopFunc-paper/gompertz_f0/nooperators/stats"
