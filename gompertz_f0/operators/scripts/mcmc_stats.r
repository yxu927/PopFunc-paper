...
mcmc_path <- "/Users/xuyuan/workspace/PopFunc-paper/gompertz_f0/operators/beast"
output_path <- "/Users/xuyuan/workspace/PopFunc-paper/gompertz_f0/operators/stats"
