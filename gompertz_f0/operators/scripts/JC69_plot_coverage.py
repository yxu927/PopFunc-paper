...
def plot_figs(stats_path, true_path, parameter_list):
    ...
    for parameter in parameter_list:
        ...
        try:
            ...
            output_path = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_f0/operators/figures/" + parameter.lower().replace(".", "_") + ".pdf"
...
stats_format = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_f0/operators/stats/gompCoal-%d_stats.log"
true_format = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_f0/operators/data/gompCoal-%d.log"
