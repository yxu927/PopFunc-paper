...
def append_stats_all():
    for i in range(100):
        tree_file = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_f0/operators/data/gompCoal-%d_tree.trees" % i
        true_file = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_f0/operators/data/gompCoal-%d.log" % i
