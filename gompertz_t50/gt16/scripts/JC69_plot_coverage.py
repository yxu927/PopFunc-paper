...
def plot_figs(stats_path, true_path, parameter_list):
    ...
    max_t50 = float('-inf')  # Initialize max t50
    ...
    for fileid in range(100):
        ...
        # Update max_t50 if the current t50 is greater
        if 't50' in true_data:
            max_t50 = max(max_t50, true_data['t50'])
    ...
    for parameter in parameter_list:
        ...
        try:
            ...
            corr_text = f"corr. = {correlations[parameter]:.2f}" if parameter in correlations else "corr. = N/A"
            plt.text(
                0.05, 0.95,
            ...
            output_path = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_t50/gt16/figures/" + parameter.lower().replace(".",
                                                                                                                "_") + ".pdf"
    ...
    # Print the max t50 value
    print(f"\nMax t50 value: {max_t50}")


# gt16 simulation 3
parameters = [
    "t50", "NInfinity", "b", "treeheight", "treelength", "delta", "epsilon",
    "pi_0", "pi_1", "pi_2", "pi_3", "pi_4", "pi_5", "pi_6", "pi_7",
    "pi_8", "pi_9", "pi_10", "pi_11", "pi_12", "pi_13", "pi_14", "pi_15",
    "rates_0", "rates_1", "rates_2", "rates_3", "rates_4", "rates_5"
]
stats_format = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_t50/gt16/stats/gomp_t50_Coal-%d_stats.log"
true_format = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_t50/gt16/data/gomp_t50_Coal-%d.log"
