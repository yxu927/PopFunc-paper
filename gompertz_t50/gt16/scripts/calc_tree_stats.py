...
def append_stats_all():
    for i in range(100):
        tree_file = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_t50/gt16/data/gomp_t50_Coal-%d_psi.trees" % i
        true_file = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_t50/gt16/data/gomp_t50_Coal-%d.log" % i
