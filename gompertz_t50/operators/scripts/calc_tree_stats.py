...
def append_stats_all():
    for i in range(100):
        tree_file = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_t50/operators/data/gomp_Coal-%d_tree.trees" % i
        true_file = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_t50/operators/data/gomp_Coal-%d.log" % i
