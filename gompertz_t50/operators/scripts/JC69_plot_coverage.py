...
def plot_figs(stats_path, true_path, parameter_list):
    ...
    for parameter in parameter_list:
        ...
        try:
            ...
            output_path = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_t50/operators/figures/" + parameter.lower().replace(".", "_") + ".pdf"
...
stats_format = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_t50/operators/stats/gomp_Coal-%d_stats.log"
true_format = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_t50/operators/data/gomp_Coal-%d.log"
