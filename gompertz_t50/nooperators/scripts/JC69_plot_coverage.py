...
def plot_figs(stats_path, true_path, parameter_list):
    ...
    for parameter in parameter_list:
        ...
        try:
            ...
            output_path = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_t50/nooperators/figures/" + parameter.lower().replace(".", "_") + ".pdf"
...
# gt16 simulation 3
parameters = ["t50", "NInfinity", "b", "tree.height", "tree.treeLength"]
stats_format = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_t50/nooperators/stats/gomp_Coal-%d_stats.log"
true_format = "/Users/xuyuan/workspace/PopFunc-paper/gompertz_t50/nooperators/data/gomp_Coal-%d.log"
