...
def append_stats_all():
    for i in range(100):
        tree_file = "/Users/xuyuan/workspace/PopFunc-paper/cons_exp_cons/data/Cons_Exp_ConsCoal-%d_true_tree.trees" % i
        true_file = "/Users/xuyuan/workspace/PopFunc-paper/cons_exp_cons/data/Cons_Exp_ConsCoal-%d_true.log" % i
