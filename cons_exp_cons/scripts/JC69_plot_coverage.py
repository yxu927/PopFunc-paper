...
def plot_figs(stats_path, true_path, parameter_list):
    ...
    for parameter in parameter_list:
        ...
        try:
            ...
            output_path = "/Users/xuyuan/workspace/PopFunc-paper/cons_exp_cons/figures/" + parameter.lower().replace(".", "_") + ".pdf"
...
# gt16 simulation 3
parameters = ["tau", "x", "r","NC" ,"tree.height", "tree.treeLength"]
stats_format = "/Users/xuyuan/workspace/PopFunc-paper/cons_exp_cons/stats/Cons_Exp_ConsCoal-%d_stats.log"
true_format = "/Users/xuyuan/workspace/PopFunc-paper/cons_exp_cons/data/Cons_Exp_ConsCoal-%d_true.log"
